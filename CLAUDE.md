...
Current design authority: `docs/ui/design-authority-thoughtful-seatmate.md`. The **consolidated visual-system closure** (which retires further visual-system experimentation) is `docs/ui/thoughtful-seatmate-visual-system-closure.md`, and the staged surface migration (**not started**) is `docs/ui/thoughtful-seatmate-visual-migration-plan.md`. The prior `docs/ui/design-authority-f3.md` is historical — it records the shipped baseline, not the target.

...
// Visual regression on the rebuilt /terms legal document (deterministic, logged-out).
...
test('terms page — visual baseline', async ({ page }) => {
  await page.goto('/terms')
  await page.waitForLoadState('networkidle')
  await expect(page).toHaveScreenshot('terms-fullpage.png', { fullPage: true })
})

  ...
  return (
    <section className="w-full select-none">
      <div className="relative w-full overflow-hidden">
        ...
        {/* CONTENT */}
        <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-end min-h-[350px]
          ...
          <div className="flex-1 mt-4 sm:mt-0 sm:ml-6 text-left min-w-0 pr-4">
            ...
            <button
              ...
              className="px-4 py-2 bg-orange-500 rounded-lg font-bold text-white

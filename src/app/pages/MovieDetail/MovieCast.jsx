...
export default function MovieCast({ cast }) {
  ...
  return (
    <div>
      <p className="text-[11px] font-semibold text-white/30 uppercase tracking-widest mb-4">Top Cast</p>
            ...
            <div key={p.id} className="flex-shrink-0 w-[88px] group">
              <div className="aspect-[2/3] overflow-hidden rounded-xl bg-white/5 border border-white/8 mb-2 shadow-md">
                {p.profile_path ? (
                  ...
                  <div className="w-full h-full grid place-items-center text-white/25 text-xs">No photo</div>
                )}
              </div>

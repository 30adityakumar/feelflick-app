  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
        ...
        <h1 className="text-4xl sm:text-5xl font-black text-white tracking-tight mb-3">Curated Lists</h1>
        <p className="text-white/60 max-w-2xl mb-10">Films grouped by theme, era, and cinematic identity.</p>

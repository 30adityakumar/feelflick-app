...
import { Bookmark, Loader2, Search, SlidersHorizontal, Trash2, X } from "lucide-react";
          ...
          <div className="mb-4 flex flex-col sm:flex-row gap-2">
            ...
            <div className="relative sm:w-48">
              ...
              <select
                ...
                className="appearance-none w-full bg-white/5 border border-white/10 rounded-lg pl-9 pr-9 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-orange-500/50 transition-all cursor-pointer"
              >

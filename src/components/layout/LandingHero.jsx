...
/**  
 * HeroText renders the main heading, subheading and CTA button.  
 */
function HeroText() {
  ...
  return (
    <div className="text-center max-w-[900px] mx-auto relative z-10 px-4 md:px-8">
      <h1
        ...
        `}
        style={{ letterSpacing: "-1.1px", filter: "drop-shadow(0 1px 16px #eb423b22)" }}
      >
...
/**
 * HeroCurveSVG renders the decorative curved bottom with gradients and masks.
 * Kept in separate component for clarity and potential lazy loading.
 */
...
/**
 * Main LandingHero component combines content and decoration.
 */

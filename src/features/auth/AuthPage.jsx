...
export default function AuthPage() {
  ...
  return (
    <>
      ...
      <main id="main" className="relative mx-auto w-full overflow-hidden">
        {/* Landing background behind everything (incl. footer) */}
        ...
        {/* Perfectly centered between TopNav and Footer */}
        <div
          className="relative z-10 flex items-center justify-center px-4 md:px-6"

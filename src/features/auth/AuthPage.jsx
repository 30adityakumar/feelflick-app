...
/**
 * Seamless auth page:
 * - Uses same multi-color background as Landing.
 * - Keeps TopNav + Footer, hides “Sign in” button via TopNav logic.
 * - No page scrolling; content centers within viewport between nav & footer.
 */
export default function AuthPage() {
  return (
    <>
      ...
      {/* Background layer identical to Landing */}
      ...
      {/* Viewport below nav — no scroll, centers form */}
      <main
        id="main"
      ...
      >
        <div className="grid h-full min-h-0 grid-rows-[1fr_auto]">
          {/* Centered panel */}
          <div className="relative mx-auto flex w-full max-w-7xl items-center justify-center px-3 md:px-6">

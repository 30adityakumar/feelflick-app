...
export default function AuthPage() {
  ...
  return (
    <>
      ...
      {/* Viewport below TopNav. We keep 1 row for the form, 1 for footer -> no scroll */}
      <main
        id="main"
        className="relative mx-auto w-full overflow-hidden"
        style={{ height: 'calc(100svh - var(--topnav-h,72px))' }}
      >
        {/* Landing gradient background (same as hero) */}
        <BackgroundGlow />

        <div className="grid h-full min-h-0 grid-rows-[1fr_auto]">
          {/* Center form card */}
          <section
            className="relative z-10 flex items-center justify-center px-3 md:px-6"
...
/* --- same glow as LandingHero, but as a tiny component to avoid duplication --- */

      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20">
          ...
          <p className="text-white/60 text-xl max-w-2xl mx-auto">
            A complete ecosystem for movie lovers. Discover, track, and watch—
            all in one place.
          </p>
        </div>
        ...
        <div ref={containerRef} className="grid md:grid-cols-3 gap-8">
          ...
          >
            <div className="absolute top-6 right-6 flex -space-x-3">
              <div className="w-10 h-10 rounded-full bg-[#E50914] border-2 border-black shadow-lg flex items-center justify-center text-[10px] font-bold text-white">
                N
              </div>
              <div className="w-10 h-10 rounded-full bg-[#00A8E1] border-2 border-black shadow-lg flex items-center justify-center text-[10px] font-bold text-white">
                P
              </div>
              <div className="w-10 h-10 rounded-full bg-[#1CE783] border-2 border-black shadow-lg flex items-center justify-center text-[10px] font-bold text-black">
                H
              </div>
            </div>
          </FeatureCard>
  ...
  return (
    ...
    >
      <div className="absolute inset-0">
        ...
        />
        <div
          className={`absolute inset-0 bg-gradient-to-b ${overlayColor} via-black/20 to-black`}
        />

...
function ServiceIconsRow({ isVisible }) {
  const services = [
    ...
    { color: "#00A8E1", label: "P", name: "Prime" },
  ...
  return (
    <div className="flex items-center gap-2.5 mt-4">
      ...
      <span className="ml-2 text-xs text-white/50 font-medium">+100 more</span>
    </div>
  )
}
...
function WatchlistPreview({ isHovered }) {
  return (
    ...
    `}>
      {/* First item */}
      <div className="bg-neutral-900/95 backdrop-blur-xl border border-amber-400/30 rounded-xl p-3 mb-2.5 shadow-[0_8px_32px_rgba(0,0,0,0.6)] transform transition-all duration-500 group-hover:translate-y-0">
...
export default function FeaturesGrid() {
  ...
  return (
    <section id="features"
      ref={sectionRef}
      className="relative pt-16 pb-24 sm:pt-20 sm:pb-32 bg-black overflow-hidden"
    >
      {/* Enhanced ambient backgrounds */}
      <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-purple-500/8 rounded-full blur-[140px] animate-pulse pointer-events-none" style={{ animationDuration: '10s' }} />
      <div className="absolute bottom-0 right-1/4 w-[600px] h-[600px] bg-pink-500/8 rounded-full blur-[140px] animate-pulse pointer-events-none" style={{ animationDuration: '12s', animationDelay: '2s' }} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-14 sm:mb-20">
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight mb-5 sm:mb-6 leading-tight">
            The{' '}
...
// Feature card with no tilt or parallax
    ...
    >
      ...
      <div className="relative p-6 sm:p-7 md:p-8 space-y-4">
        ...
        <div className="flex items-center justify-between gap-3">
          <div className={`rounded-xl p-2.5 shadow-lg ${iconBg}`}>
            {icon}
          </div>

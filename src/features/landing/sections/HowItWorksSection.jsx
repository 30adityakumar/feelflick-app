      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16 md:mb-20 max-w-3xl mx-auto">
          <h2
            ...
            className="text-hero font-black tracking-tight mb-6 leading-tight text-white"
          >
          ...
          <p className="text-base sm:text-lg text-white/65 leading-relaxed max-w-2xl mx-auto">
            Every streaming service shows you what's popular right now — not what's right for{' '}
            <em className="not-italic text-white">you</em> right now. FeelFlick matches your mood
            to a film, then shows you every service where you can watch it tonight.
          </p>

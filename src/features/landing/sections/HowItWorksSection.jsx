    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-2 lg:gap-20 items-center">
          ...
          {/* VISUAL: iPhone Mockup - Corrected Sizing */}
          <div className="relative mx-auto lg:mx-0 w-[300px] h-[600px] mb-16 lg:mb-0">
            {/* Glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[500px] bg-purple-500/20 blur-[80px] rounded-full" />
            
            {/* Phone Frame */}
            <div className="relative z-10 w-full h-full border-8 border-neutral-800 bg-black rounded-[2.5rem] shadow-2xl overflow-hidden ring-1 ring-white/10">
              {/* Screen Content */}
                  ...
                  <div className="relative flex-1 rounded-2xl overflow-hidden mb-4 shadow-lg group">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-5">
                      ...
                      <div className="flex items-center gap-2 mt-2 text-white/60 text-sm">
                        <span>1994</span><span>•</span><span>Crime, Drama</span>
                      </div>
                    </div>
                  </div>
                  <div className="flex gap-3 h-16">
                    <button className="flex-1 rounded-xl bg-red-500/10 border border-red-500/20 flex items-center justify-center text-red-500 hover:bg-red-500/20 transition-colors"><ThumbsDown className="w-6 h-6" /></button>
                    <button className="flex-1 rounded-xl bg-green-500/10 border border-green-500/20 flex items-center justify-center text-green-500 hover:bg-green-500/20 transition-colors"><ThumbsUp className="w-6 h-6" /></button>
                  </div>
                </div>
...
// Step component remains the same...

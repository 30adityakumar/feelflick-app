import { C, ROSE, ROSE_DEEP } from '@/shared/lib/tokens'
      ...
      <div style={{maxWidth:880,margin:'0 auto'}}>
        <Reveal>
          <div style={{textAlign:'center',marginBottom:48}}>
            <Eyebrow color={ROSE} style={{marginBottom:14}}>Meet M., your curator</Eyebrow>
        ...
        <Reveal delay={150}>
          ...
          <div style={{position:'relative',maxWidth:720,margin:'0 auto',padding:'56px 56px',borderRadius:16,background:'rgba(15,12,24,0.78)',border:`1px solid ${C.hairline}`,boxShadow:'0 32px 60px -20px rgba(0,0,0,0.7)'}}>
            <div aria-hidden style={{position:'absolute',top:-26,right:32,width:52,height:52,borderRadius:999,background:ROSE_DEEP,display:'flex',alignItems:'center',justifyContent:'center',fontFamily:'Inter, sans-serif',fontWeight:700,fontSize:22,color:'#fff',boxShadow:'0 12px 24px -8px rgba(0,0,0,0.6)'}}>M</div>

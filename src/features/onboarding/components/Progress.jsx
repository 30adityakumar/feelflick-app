...
export default function Progress({ step }) {
  return (
    <div className="flex-none px-5 pt-4 pb-1 sm:px-6 sm:pt-6 flex items-center gap-3 sm:gap-4">
      <span className="ob-display text-[13px] sm:text-[15px] font-extrabold tracking-[0.02em] bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent">
        FEELFLICK
      </span>

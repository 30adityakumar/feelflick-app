  ...
  return (
    <article className="ff-people-card" role="listitem">
      <div className="ff-people-card__top">
        <Link to={`/people/${p.id}`} className="ff-people-card__avatar-link" aria-label={`View ${p.name}'s profile`}>
      ...
      <Link to={`/people/${p.id}`} className="ff-people-card__name-link" tabIndex={-1} aria-hidden="true">

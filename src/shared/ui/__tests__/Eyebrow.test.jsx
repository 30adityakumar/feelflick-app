...
describe('Eyebrow', () => {
  ...
  it('reconciles the landing "quiet" eyebrow via weight/color overrides (one contract)', () => {
    // The landing's .ff-eyebrow look (Outfit 600 / white-.42) is representable on
